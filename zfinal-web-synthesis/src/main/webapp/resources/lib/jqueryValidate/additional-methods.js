(function() {
	...
	}, jQuery.validator.format("请输入{0}字以内.")); 
...
var decimal = /^-?\d+(\.\d{1,2})?$/;   
return this.optional(element) || (decimal.test(value));},"验证值小数位数不能超过两位");  
...
jQuery.validator.addMethod("mobile", function(value, element) {
 var length = value.length;
 var mobile =  /^(((1[0-9]{1}[0-9]{1}))+\d{8})$/;///^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8})$/
